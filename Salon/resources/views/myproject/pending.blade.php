...
<form action={{url('/pendingadminorder/'.$name.'/'.$count)}}>
  <p style="font-size:20px;font-weight:20px;color:white;">enter order id:-</p>
  <input type="number" name="pendingid" palceholder="enter order id">
    <p style="font-size:20px;font-weight:20px;color:white;">enter the action:-</p>
  <input type="text" name="pendingaction" palceholder="enter order id"><br><br>
