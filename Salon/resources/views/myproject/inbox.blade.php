...
background: url("http://localhost/Salon/storage/app/images/clean.png");
...
background: url("http://localhost/Salon/storage/app/images/spa1.jpg");
...
#cont3 {
  ...
  background: url("http://localhost/Salon/storage/app/images/n1.jpg");
 ...
 background-size: cover;
  ...
  #cont4 {
    ...
    background: url("http://localhost/Salon/storage/app/images/pedi.jpg");
...
<div class="bottom-left"><div data-aos="fade-right">
            ...
            <p><span><a href="{{url('/mainhome')}}"><b>Home</b></a></span>><span class="small">indoor</span></p></div>
</div>
