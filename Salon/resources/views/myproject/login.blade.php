...
<center>
  ...
  <form action="logged" style="background-color:pink;">
      <p>Log IN</p>
    <p>email:
  ...
  <!-- <a href ="{{url('/logged')}}" class="btn btn-md btn-warning pull-right">login</a> -->
<input type="submit" name="submit" value="submit" class="btn btn-md btn-warning">
</form>
<br><br>

  <a href ="{{url('/newuser')}}" class="btn btn-md btn-warning">not a member?sign up</a>
</center>
  </body>
</html>
